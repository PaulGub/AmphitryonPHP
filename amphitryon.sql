...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 10 mai 2022 à 09:29
...
(9, '2022-05-10 11:04:07', 2, 2),
(10, '2022-05-10 11:11:56', 1, 4),
(11, '2022-05-10 11:12:54', 1, 4),
(12, '2022-05-10 11:13:37', 2, 3);
...
INSERT INTO `etat_commande` (`id`, `libelleCommande`) VALUES
(1, 'non payer'),
(2, 'payer');
...
--
-- Structure de la table `etat_plat`
--

DROP TABLE IF EXISTS `etat_plat`;
CREATE TABLE IF NOT EXISTS `etat_plat` (
...
--
-- Déchargement des données de la table `etat_plat`
--

INSERT INTO `etat_plat` (`id`, `libellePlat`) VALUES
(1, 'commandée'),
(2, 'servi'),
(3, 'desservi');
...
--
-- Déchargement des données de la table `platcommander`
--

INSERT INTO `platcommander` (`idCommande`, `idPlat`, `quantiteedemandee`, `infosComplementaires`, `etatPlat`) VALUES
(9, 1, 7, 'pas très chaud', 1),
(9, 4, 4, 'sans fromage', 3),
(10, 2, 2, 'sans olives', 1),
(10, 3, 1, 'saignant', 1),
(11, 1, 1, 'sans oeufs', 1),
(11, 4, 9, 'avec sauce', 3);
...
(1, 1, '2022-04-15', 30, 0, '12.00'),
(2, 1, '2022-05-10', 25, 0, '14.00'),
(3, 1, '2022-05-02', 25, 0, '7.00'),
(4, 1, '2022-04-15', 30, 0, '9.00');
...
ALTER TABLE `commande`
  ...
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`etatCommande`) REFERENCES `etat_commande` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `platcommander`
  ...
  ADD CONSTRAINT `platcommander_ibfk_3` FOREIGN KEY (`etatPlat`) REFERENCES `etat_plat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
